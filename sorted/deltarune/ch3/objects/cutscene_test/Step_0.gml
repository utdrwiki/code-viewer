...
if (con == 2)
{
    ...
    c_emote("!", 30);
    c_speaker("susie");
    c_msgsetloc(0, "\\E7* Hey^1, is that... Lancer!?/%", "obj_cutscene_test_slash_Step_0_gml_51_0_b");
    c_talk_wait();
    c_msgzurasu(1);
    c_pannable(1);
    c_panspeed(5, 0, 35);
    c_sel(kr);
    c_walkdirect_speed_wait(936, 240, 2);
    c_facing("r");
    c_sel(su);
    ...
    c_var("friction", 0.6);
    c_delayfacing(16, "r");
    c_wait_if(ra_actor, "x", ">=", 920);
    c_sprite(spr_ralsei_chef);
    c_var("friction", 0);
    c_var("speed", 0);
    c_soundplay(snd_explosion);
    c_var_instance(ra_actor, "image_yscale", 4);
    c_wait(16);
    c_msgside("bottom");
    c_speaker("susie");
    ...
    c_visible(0);
    c_speaker("susie");
    c_msgsetloc(0, "\\Ez* What the!?/", "obj_cutscene_test_slash_Step_0_gml_259_0");
