...
if (global.myfight == 3)
{
    ...
    {
        actcon = 1;
        msgsetloc(0, "* ELNINA - She's just over the moon for Lanino./%", "obj_elnina_enemy_slash_Step_0_gml_39_0_b");
        scr_battletext_default();
    }
    if (acting == 2 && actcon == 0)
    {
        msgsetloc(0, "* Kris says I Love TV to Elnina!/%", "obj_elnina_enemy_slash_Step_0_gml_46_0");
        scr_battletext_default();
    ...
    {
        msgsetloc(0, "* Everyone said I Love TV to Elnina!/%", "obj_elnina_enemy_slash_Step_0_gml_79_0");
        scr_battletext_default();
        if (obj_elnina_lanino_controller.sunboost > -3)
            obj_elnina_lanino_controller.sunboost--;
        acting = 200;
    ...
    {
        msgsetloc(0, "* Susie said \"I Love TV!\"/%", "obj_elnina_enemy_slash_Step_0_gml_110_0_b");
        scr_simultext("susie");
        if (simulordersus == 0)
            actconsus = 20;
        else
    ...
    {
        msgsetloc(0, "* Ralsei said \"I Love TV!\"/%", "obj_elnina_enemy_slash_Step_0_gml_120_0_b");
