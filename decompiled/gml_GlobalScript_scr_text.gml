scr_text = function(argument0) //gml_Script_scr_text
{
    switch argument0
    {
        case 0:
        ...
        case 1079:
            ...
            break
        case 1080:
            itemgetstring = stringsetloc("%%", "scr_text_slash_scr_text_gml_4596_0")
            if (global.choice == 0)
        ...
        case 1104:
            if (global.choice == 0)
            {
                ...
                {
                    itemgetstring = scr_itemget_anytype_text(9, "item")
                    if (noroom == false)
                    {
                        scr_speaker("lancer")
        ...
        case 1146:
            if (global.choice == 0)
            {
                ...
                if can_afford
                {
                    itemgetstring = scr_itemget_anytype_text(16, "item")
                    if (noroom == false)
                    {
                        global.gold -= 400
                        scr_miniface_init_sweet()
