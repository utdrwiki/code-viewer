...
if (room == room_town_north)
{
    if (x > 1440)
    {
        ...
        {
            scr_speaker("no_name");
            msgsetloc(0, "* (Your dad's truck.)/%", "obj_npc_sign_slash_Other_10_gml_51_0");
            if (global.plot < 300)
            {
                if (read == 0)
                {
                    scr_speaker("susie");
                    msgsetloc(0, "\\E2* Alright^1, Kris. You handle the driving^1, I'll be the turret./", "obj_npc_sign_slash_Other_10_gml_58_0");
                    msgnextloc("\\EA* Y'know^1, I'll be standing in back^1, throwing..^1. dirt and stuff./%", "obj_npc_sign_slash_Other_10_gml_59_0");
                }
                else
                {
                    scr_speaker("susie");
                    msgsetloc(0, "\\E6* ..^1. hey^1, what's with the door at the back of the shop?/%", "obj_npc_sign_slash_Other_10_gml_63_0");
                }
            }
        }
    }
    if (global.chapter >= 2)
    {
        if (x > 1200 && x < 1300)
        {
            ...
            {
                scr_speaker("no_name");
                msgsetloc(0, "* (It's closed.)/%", "obj_npc_sign_slash_Other_10_gml_81_0");
            }
        }
    }
}
if (room == room_beach)
{
    ...
    if (global.chapter == 4)
    {
        ...
        {
            scr_speaker("no_name");
            msgsetloc(0, "* (The wet picnic table glistens in the moonlight.)/%", "obj_npc_sign_slash_Other_10_gml_108_0");
        }
        else if (global.plot >= 100)
        {
            if (scr_havechar(2))
            {
                if (scr_flag_get(774) == 0)
                {
                    scr_flag_set(774, 1);
                    scr_speaker("susie");
                    msgsetloc(0, "\\E7* French fry^1, (oo)^1, on the ground and soggy./", "obj_npc_sign_slash_Other_10_gml_120_0_b");
                    msgnextloc("\\E9* Am I gonna eat it? (No!) I ain't some^1, uh^1, doggy./%", "obj_npc_sign_slash_Other_10_gml_121_0_b");
                }
                else
                {
                    scr_speaker("susie");
                    msgsetloc(0, "\\E4* Don't MAKE me repeat myself./%", "obj_npc_sign_slash_Other_10_gml_125_0");
                }
            }
        }
        else if (scr_havechar(2))
        {
            if (scr_flag_get(773) == 0)
            {
                scr_flag_set(773, 1);
                scr_speaker("susie");
                msgsetloc(0, "\\E7* French fry^1, (oo)^1, on the freaking ground./", "obj_npc_sign_slash_Other_10_gml_137_0_b");
                msgnextloc("\\E9* Am I gonna eat it? (No!) It's old and brown./%", "obj_npc_sign_slash_Other_10_gml_138_0");
            }
            else
            {
                scr_speaker("susie");
                msgsetloc(0, "\\E4* Don't MAKE me repeat myself./%", "obj_npc_sign_slash_Other_10_gml_142_0");
            }
        }
    }
}
if (room == room_town_krisyard)
{
    ...
    if (global.chapter == 4)
    {
        if (scr_havechar(2) && global.plot < 300)
        {
            if (read == 0)
            {
                scr_speaker("susie");
                msgsetloc(0, "\\E7* Think your mom'd mind if we street raced in her van?/", "obj_npc_sign_slash_Other_10_gml_161_0");
                msgnextloc("\\EK* ..^1. well^1, maybe your tires need some air first^1, heh./%", "obj_npc_sign_slash_Other_10_gml_162_0");
            }
            else
            {
                scr_speaker("susie");
                msgsetloc(0, "\\E2* Heh^1, I can imagine your mom now.../", "obj_npc_sign_slash_Other_10_gml_166_0");
                msgnextloc("\\E9* \"Kris honey^1, can you teach Susie how to drift?\" Heheh./%", "obj_npc_sign_slash_Other_10_gml_167_0");
            }
        }
    }
}
...
{
    if (sprite_index == spr_dw_ralsei_plush)
    {
        scr_speaker("no_name");
        msgsetloc(0, "* (It's a Ralsei plush from the orb-tossing game.)/%", "obj_npc_sign_slash_Other_10_gml_443_0");
        if (scr_havechar("ralsei") && scr_flag_get(711) == 0)
        {
            scr_flag_set(711, 1);
            scr_speaker("ralsei");
            msgsetloc(0, "\\E1* This..^1. was..^1. my first possession^1, just for me./", "obj_npc_sign_slash_Other_10_gml_450_0");
            msgnextloc("\\E2* Since you gave it to me^1, I..^1. I..^1. hold it every night./", "obj_npc_sign_slash_Other_10_gml_451_0");
            msgnextloc("\\E1* Perhaps it sounds silly^1, but since then..^1. my.../", "obj_npc_sign_slash_Other_10_gml_452_0");
            msgnextloc("\\E2* My first selfish desire^1, was \"I want more plushies...\" haha!/%", "obj_npc_sign_slash_Other_10_gml_453_0");
        }
    }
}
...
{
    scr_speaker("no_name");
    msgsetloc(0, "* (T\"E\"MPORARY P\"E\"ZZA STAND!)/", "obj_npc_sign_slash_Other_10_gml_486_0");
    msgnextloc("* (Sign Is closed for repairs^1! ..^1. Store!)/%", "obj_npc_sign_slash_Other_10_gml_487_0");
}
read += 1;
myinteract = 3;
if (skip == 0)
