...
if (scr_debug() && sunkus_kb_check_pressed(78))
    scr_debug_print("   " + string(timer));
if (timer == 0)
{
    snd_free_all();
    ...
    line[1] = stringsetloc("Chapter 4", "obj_credits_slash_Step_0_gml_22_0");
    line[2] = stringset(" ");
    line[3] = stringsetloc("by Toby Fox", "obj_credits_slash_Step_0_gml_24_0");
}
timer++;
var timer_interval = 57;
...
if (timer == 1611)
{
    ...
    line[4] = stringsetloc("in Chapter 5", "obj_credits_slash_Step_0_gml_192_0");
    line[5] = stringset(" ");
    line[6] = stringset(" ");
    line[7] = stringset(" ");
    linecolor[0] = c_white;
