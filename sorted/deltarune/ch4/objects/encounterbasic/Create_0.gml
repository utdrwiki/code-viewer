...
if (gerson_arena_mode)
{
    if (room == room_dw_church_arena)
    {
        ...
        battlestartdelay = 25;
        c[0] = scr_dark_marker(global.cinstance[0].x, global.cinstance[0].y, spr_susie_idle);
    }
    if (room == room_dw_churchb_nongerson)
    {
        global.heromakex[0] = 108;
        global.heromakey[0] = 149;
        c[0] = scr_dark_marker(global.cinstance[0].x, global.cinstance[0].y, spr_susier_dark);
    }
}
else
{
