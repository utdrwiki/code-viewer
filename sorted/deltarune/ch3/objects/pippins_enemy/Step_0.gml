...
if (global.myfight == 3)
{
    ...
    if (acting == 1 && actcon == 0)
    {
        ...
        msgsetloc(0, "* PIPPINS - AT \\I0 DF \\I1 &* This crooked gambler from Card Castle always bets it all!/%", "obj_pippins_enemy_slash_Step_0_gml_170_0");
    ...
    if (acting == 4 && actcon == 0)
    {
        ...
        {
            msgsetloc(0, "* You don't have enough points to bribe Pippins!/%", "obj_pippins_enemy_slash_Step_0_gml_324_0");
            scr_battletext_default();
            actcon = 1;
        }
    }
