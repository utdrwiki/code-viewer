function scr_texttype()
{
    ...
    switch (global.typer)
    {
        ...
        case 79:
            ...
            break;
        case 80:
            scr_textsetup(scr_84_get_font("main"), c_white, x, y, 33, 0, 1, snd_nosound, 8, 18, 0);
            break;
        case 81:
            scr_textsetup(scr_84_get_font("dotumche"), c_white, x, y, 33, 0, 1, snd_nosound, 9, 20, 0);
            extra_ja_vspace = 2;
            break;
        case 82:
            scr_textsetup(scr_84_get_font("mainbig"), c_white, x, y, 33, 0, 1, snd_txtjack_high_cute, 16, 36, 1);
            break;
        case 83:
        ...
        case 84:
            ...
            break;
        case 85:
            scr_textsetup(scr_84_get_font("mainbig"), c_white, x, y, 33, 0, 1, snd_txger, 16, 36, 1);
            break;
        case 86:
            scr_textsetup(scr_84_get_font("dotumche"), c_black, x, y, 33, 0, 1, snd_txger, 9, 20, 0);
            extra_ja_vspace = 2;
            break;
        case 87:
            ...
            break;
        case 88:
            scr_textsetup(scr_84_get_font("dotumche"), c_black, x, y, 33, 0, 1, snd_txtjack_low2, 9, 20, 0);
            extra_ja_vspace = 2;
            break;
        case 666:
        ...
        case 999:
            ...
            break;
        case 100:
            scr_textsetup(scr_84_get_font("8bit"), c_white, x, y, 22, 0, 1, snd_text, 16, 20, 0);
            break;
        default:
            font_set = false;
            break;
