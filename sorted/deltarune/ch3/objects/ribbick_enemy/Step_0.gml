...
if (global.monster[myself] == 1)
{
    ...
    if (scr_isphase("bullets") && attacked == 0)
    {
        ...
        if (rtimer == 12)
        {
            ...
            {
                if (scr_messagepriority(200 + random(2)))
                {
                    if (rr == 0)
                ...
                if (global.mercymod[myself] >= global.mercymax[myself] && scr_messagepriority(300 + random(2)))
                    global.battlemsg[0] = stringsetloc("* Rabbick is now nice and clean. ", "obj_ribbick_enemy_slash_Step_0_gml_183_0");
                if (global.monsterhp[myself] <= (global.monstermaxhp[myself] / 3) && scr_messagepriority(300 + random(2)))
...
if (global.myfight == 3)
{
    ...
    if (acting == 100)
    {
        msgsetsubloc(0, "* Press ~1 repeatedly!", scr_get_input_name(6), "obj_ribbick_enemy_slash_Step_0_gml_231_0");
        scr_battletext_default();
        acting = 101;
        clocktimer = 11;
    }
