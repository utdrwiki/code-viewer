letters1 = stringsetloc("POPULARITY", "obj_susiezilla_perfect_popularity_slash_Create_0_gml_1_0");
letters2 = stringsetloc("BONUS", "obj_susiezilla_perfect_popularity_slash_Create_0_gml_2_0");
