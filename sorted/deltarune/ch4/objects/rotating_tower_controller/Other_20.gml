...
if (wide_tower == true)
{
    ...
    if (ii == 0)
    {
        ...
        else
        {
            ...
            if (_tower_angle > 120)
                x_fix = 0;
            if (_tower_angle >= 350)
                xx = lerp(piecemaxdistance * -1, 0, scr_ease_in((_tower_angle - 350) / 100, columnsize)) + x_fix;
            if (_tower_angle < 90)
                xx = lerp(piecemaxdistance * -1, 0, scr_ease_in((10 + tower_angle) / 100, columnsize)) + x_fix;
            if (_tower_angle >= 90 && _tower_angle < 190)
                xx = lerp(0, piecemaxdistance, scr_ease_out((_tower_angle - 90) / 100, columnsize)) + x_fix;
        }
        if (_tower_angle >= 190 && _tower_angle < 350)
        {
            ...
            if (_tower_angle > 190 && _tower_angle < 270)
                xx = lerp(piecemaxdistance, 0, scr_ease_in((_tower_angle - 190) / 80, columnsize));
            if (_tower_angle > 270 && _tower_angle < 350)
                xx = lerp(0, piecemaxdistance * -1, scr_ease_out((_tower_angle - 270) / 80, columnsize));
    ...
    if (ii == 1)
    {
        ...
        {
            if (_tower_angle >= 25 && _tower_angle < 125)
                xx = lerp(piecemaxdistance * -1, 0, scr_ease_in((_tower_angle - 25) / 100, columnsize));
            if (_tower_angle >= 125 && _tower_angle < 225)
                xx = lerp(0, piecemaxdistance, scr_ease_out((_tower_angle - 125) / 100, columnsize));
        }
        if (_tower_angle >= 225 || _tower_angle < 25)
        {
            ...
            if (_tower_angle >= 225 && _tower_angle < 305)
                xx = lerp(piecemaxdistance, 0, scr_ease_in((_tower_angle - 225) / 80, columnsize));
            if (_tower_angle >= 305)
                xx = lerp(0, piecemaxdistance * -1, scr_ease_out((_tower_angle - 305) / 80, columnsize));
            if (_tower_angle < 25)
                xx = lerp(0, piecemaxdistance * -1, scr_ease_out((_tower_angle + 55) / 80, columnsize));
    ...
    if (ii == 2)
    {
        ...
        {
            if (_tower_angle >= 60 && _tower_angle < 160)
                xx = lerp(piecemaxdistance * -1, 0, scr_ease_in((_tower_angle - 60) / 100, columnsize));
            if (_tower_angle >= 160 && _tower_angle < 260)
                xx = lerp(0, piecemaxdistance, scr_ease_out((_tower_angle - 160) / 100, columnsize));
        }
        if (_tower_angle >= 260 || _tower_angle < 60)
        {
            ...
            if (_tower_angle >= 260 && _tower_angle < 340)
                xx = lerp(piecemaxdistance, 0, scr_ease_in((_tower_angle - 260) / 80, columnsize));
            if (_tower_angle >= 340 && _tower_angle <= 360)
                xx = lerp(0, piecemaxdistance * -1, scr_ease_out((_tower_angle - 340) / 80, columnsize));
            if (_tower_angle <= 60)
                xx = lerp(0, piecemaxdistance * -1, scr_ease_out((_tower_angle + 20) / 80, columnsize));
    ...
    if (ii == 3)
    {
        ...
        {
            if (_tower_angle >= 95 && _tower_angle < 195)
                xx = lerp(piecemaxdistance * -1, 0, scr_ease_in((_tower_angle - 95) / 100, columnsize));
            if (_tower_angle >= 195 && _tower_angle < 295)
                xx = lerp(0, piecemaxdistance, scr_ease_out((_tower_angle - 195) / 100, columnsize));
        }
        if (_tower_angle >= 295 || _tower_angle < 95)
        {
            ...
            if (_tower_angle >= 295 && _tower_angle <= 360)
                xx = lerp(piecemaxdistance, 0, scr_ease_in((_tower_angle - 295) / 80, columnsize));
            if (_tower_angle < 15)
                xx = lerp(piecemaxdistance, 0, scr_ease_in((_tower_angle + 65) / 80, columnsize));
            if (_tower_angle >= 15 && _tower_angle < 95)
                xx = lerp(0, piecemaxdistance * -1, scr_ease_out((_tower_angle - 15) / 80, columnsize));
    ...
    if (ii == 4)
    {
        ...
        {
            if (_tower_angle >= 130 && _tower_angle < 230)
                xx = lerp(piecemaxdistance * -1, 0, scr_ease_in((_tower_angle - 130) / 100, columnsize));
            if (_tower_angle >= 230 && _tower_angle < 330)
                xx = lerp(0, piecemaxdistance, scr_ease_out((_tower_angle - 230) / 100, columnsize));
        }
        if (_tower_angle >= 330 || _tower_angle < 130)
        {
            ...
            if (_tower_angle >= 330 && _tower_angle <= 360)
                xx = lerp(piecemaxdistance, 0, scr_ease_in((_tower_angle - 330) / 80, columnsize));
            if (_tower_angle >= 0 && _tower_angle <= 50)
                xx = lerp(piecemaxdistance, 0, scr_ease_in((_tower_angle + 30) / 80, columnsize));
            if (_tower_angle >= 50 && _tower_angle < 130)
                xx = lerp(0, piecemaxdistance * -1, scr_ease_out((_tower_angle - 50) / 80, columnsize));
    ...
    if (ii == 5)
    {
        ...
        {
            if (_tower_angle >= 165 && _tower_angle < 265)
                xx = lerp(piecemaxdistance * -1, 0, scr_ease_in((_tower_angle - 165) / 100, columnsize));
            if (_tower_angle >= 265)
                xx = lerp(0, piecemaxdistance, scr_ease_out((_tower_angle - 265) / 100, columnsize));
            if (_tower_angle <= 5)
                xx = lerp(0, piecemaxdistance, scr_ease_out((95 + _tower_angle) / 100, columnsize));
        }
        if (_tower_angle > 5 && _tower_angle < 165)
        {
            ...
            if (_tower_angle >= 5 && _tower_angle < 85)
                xx = lerp(piecemaxdistance, 0, scr_ease_in((_tower_angle - 5) / 80, columnsize));
            if (_tower_angle >= 85 && _tower_angle < 165)
                xx = lerp(0, piecemaxdistance * -1, scr_ease_out((_tower_angle - 85) / 80, columnsize));
    ...
    if (ii == 6)
    {
        ...
        {
            if (_tower_angle >= 200 && _tower_angle < 300)
                xx = lerp(piecemaxdistance * -1, 0, scr_ease_in((_tower_angle - 200) / 100, columnsize));
            if (_tower_angle >= 300)
                xx = lerp(0, piecemaxdistance, scr_ease_out((_tower_angle - 300) / 100, columnsize));
            if (_tower_angle <= 40)
                xx = lerp(0, piecemaxdistance, scr_ease_out((60 + _tower_angle) / 100, columnsize));
        }
        if (_tower_angle > 40 && _tower_angle < 200)
        {
            ...
            if (_tower_angle >= 40 && _tower_angle < 120)
                xx = lerp(piecemaxdistance, 0, scr_ease_in((_tower_angle - 40) / 80, columnsize));
            if (_tower_angle >= 120 && _tower_angle < 200)
                xx = lerp(0, piecemaxdistance * -1, scr_ease_out((_tower_angle - 120) / 80, columnsize));
    ...
    if (ii == 7)
    {
        ...
        {
            if (_tower_angle >= 235 && _tower_angle < 335)
                xx = lerp(piecemaxdistance * -1, 0, scr_ease_in((_tower_angle - 235) / 100, columnsize));
            if (_tower_angle >= 335)
                xx = lerp(0, piecemaxdistance, scr_ease_out((_tower_angle - 335) / 100, columnsize));
            if (_tower_angle <= 75)
                xx = lerp(0, piecemaxdistance, scr_ease_out((25 + _tower_angle) / 100, columnsize));
        }
        if (_tower_angle > 75 && _tower_angle < 235)
        {
            ...
            if (_tower_angle >= 75 && _tower_angle < 155)
                xx = lerp(piecemaxdistance, 0, scr_ease_in((_tower_angle - 75) / 80, columnsize));
            if (_tower_angle >= 155 && _tower_angle < 235)
                xx = lerp(0, piecemaxdistance * -1, scr_ease_out((_tower_angle - 155) / 80, columnsize));
    ...
    if (ii == 8)
    {
        ...
        {
            if (_tower_angle >= 270)
                xx = lerp(piecemaxdistance * -1, 0, scr_ease_in((_tower_angle - 270) / 100, columnsize));
            if (_tower_angle <= 10)
                xx = lerp(0, piecemaxdistance, scr_ease_out((_tower_angle - 10) / 100, columnsize));
            if (_tower_angle >= 10 && _tower_angle <= 110)
                xx = lerp(0, piecemaxdistance, scr_ease_out((_tower_angle - 10) / 100, columnsize));
        }
        if (_tower_angle > 110 && _tower_angle < 270)
        {
            ...
            if (_tower_angle >= 110 && _tower_angle < 190)
                xx = lerp(piecemaxdistance, 0, scr_ease_in((_tower_angle - 110) / 80, columnsize));
            if (_tower_angle >= 190 && _tower_angle < 270)
                xx = lerp(0, piecemaxdistance * -1, scr_ease_out((_tower_angle - 190) / 80, columnsize));
    ...
    if (ii == 9)
    {
        ...
        else
        {
            var x_fix = 0;
            if (_tower_angle >= 305)
                xx = lerp(piecemaxdistance * -1, 0, scr_ease_in((_tower_angle - 305) / 100, columnsize)) - 3;
            if (_tower_angle <= 45)
                xx = lerp(0, piecemaxdistance, scr_ease_out((_tower_angle - 45) / 100, columnsize)) - 3;
            if (_tower_angle >= 45 && _tower_angle <= 145)
                xx = lerp(0, piecemaxdistance, scr_ease_out((_tower_angle - 45) / 100, columnsize)) - 3;
        }
        if (_tower_angle > 145 && _tower_angle < 305)
        {
            ...
            if (_tower_angle >= 145 && _tower_angle < 225)
                xx = lerp(piecemaxdistance, 0, scr_ease_in((_tower_angle - 145) / 80, columnsize));
            if (_tower_angle >= 225 && _tower_angle < 305)
                xx = lerp(0, piecemaxdistance * -1, scr_ease_out((_tower_angle - 225) / 80, columnsize));
