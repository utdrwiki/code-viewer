scr_pan_to_obj_ch1 = function(argument0, argument1) //gml_Script_scr_pan_to_obj_ch1
{
    ...
    scr_pan_ch1(((_vx - __view_get((0 << 0), 0)) / argument1), ((_vy - __view_get((1 << 0), 0)) / argument1), argument1)
    return;
}
