function scr_litemuseb(arg0, arg1)
{
    switch (arg1)
    {
        ...
        case 10:
            ...
            break;
        case 11:
            if (scr_flag_get(1271) == 0)
            {
                scr_flag_set(1271, 1);
                scr_speaker("no_name");
                msgsetloc(0, "* You held the crystal up to your eye./", "scr_litemuseb_slash_scr_litemuseb_gml_171_0_c");
                msgnextloc("* For some strange reason^1, for just a brief moment.../", "scr_litemuseb_slash_scr_litemuseb_gml_172_0_c");
                msgnextloc("* You thought you saw Undyne frozen in ice./%", "scr_litemuseb_slash_scr_litemuseb_gml_173_0");
            }
            else if (scr_flag_get(1272) == 0)
            {
                scr_flag_set(1272, 1);
