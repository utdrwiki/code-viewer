function scr_text(arg0)
{
    switch (arg0)
    {
        ...
        case 1243:
            ...
            break;
        case 1250:
            global.choicemsg[0] = stringsetloc("#Of course.#Games are fun", "scr_text_slash_scr_text_gml_7717_0");
            global.choicemsg[1] = stringsetloc("#No", "scr_text_slash_scr_text_gml_7718_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            msgsetloc(0, "* You seriously enjoy this?/", "scr_text_slash_scr_text_gml_7721_0");
            msgnextloc(" \\C2", "scr_text_slash_scr_text_gml_7722_0");
            break;
        case 1251:
            msgset(0, "%%");
            if (global.choice == 0)
            {
                with (obj_swordroute_event_leavescreen)
                    con = 25;
            }
            else
            {
            ...
            break;
        case 1252:
            global.choicemsg[0] = stringsetloc("#Yes", "scr_text_slash_scr_text_gml_7739_0");
            global.choicemsg[1] = stringsetloc("#No", "scr_text_slash_scr_text_gml_7740_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            msgsetloc(0, "* (Looks like a game console.)/", "scr_text_slash_scr_text_gml_7743_0");
            msgnextloc("* (Play it?)/", "scr_text_slash_scr_text_gml_7744_0");
            msgnextloc(" \\C2", "scr_text_slash_scr_text_gml_7745_0");
            break;
        case 1253:
            msgset(0, "%%");
            break;
        case 1254:
            global.choicemsg[0] = stringsetloc("#Buy", "scr_text_slash_scr_text_gml_7757_0");
            global.choicemsg[1] = stringsetloc("#Don't Buy", "scr_text_slash_scr_text_gml_7758_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* (POINTs to ITEMs!)&* (Use the vending machine?)/", "scr_text_slash_scr_text_gml_7762_0");
            msgnext("\\C2");
            break;
        case 1255:
            if (global.choice == 0)
            {
                scr_speaker("no_name");
                msgset(0, "%%");
                instance_create(camerax(), cameray(), obj_shop_vending_changing);
                exit;
            }
            if (global.choice == 1)
            {
            ...
            break;
        case 1256:
            global.choicemsg[0] = stringsetloc("#Yes", "scr_text_slash_scr_text_gml_7787_0");
            global.choicemsg[1] = stringsetloc("#No", "scr_text_slash_scr_text_gml_7788_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* Kris^1, heheh^1! Just between us..^1. You like gambling?/", "scr_text_slash_scr_text_gml_7792_0");
            msgnext("\\C2");
            break;
        case 1257:
            if (global.choice == 0)
            {
                scr_speaker("no_name");
                msgsetloc(0, "* ..^1. that's not true. You just like cheating./%", "scr_text_slash_scr_text_gml_7801_0");
            }
            if (global.choice == 1)
            {
                scr_speaker("no_name");
                msgsetloc(0, "* ..^1. What happened to your GUTS? Come on^1, have some higher stats!/%", "scr_text_slash_scr_text_gml_7807_0");
            }
            break;
        case 1258:
            global.choicemsg[0] = stringsetloc("#Buy#something", "scr_text_slash_scr_text_gml_7814_0");
            global.choicemsg[1] = stringsetloc("#Talk#more", "scr_text_slash_scr_text_gml_7815_0");
            global.choicemsg[2] = stringsetloc("Nothing#else", "scr_text_slash_scr_text_gml_7816_0");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            if (scr_flag_get(1032) == 0)
            {
                scr_flag_set(1032, 1);
                scr_speaker("no_name");
                msgsetloc(0, "\\M1* Oi^1, Kris^1, luv^1! It's me^1, Ramb^1! You and your brother took me here from the Library!/", "scr_text_slash_scr_text_gml_7825_0");
                msgnextloc("* How're they all? Queen still bossy? Swatch still got a mohawk? And that salesman.../", "scr_text_slash_scr_text_gml_7826_0");
                msgnextloc("* Right^1, the store^1, the store^1! If you want anything^1, just use your POINTs!/", "scr_text_slash_scr_text_gml_7827_0");
            }
            else
            {
                msgsetloc(0, "\\M1* Kris^1, luv^1! If you've got POINTs^1, we've got ITEMs!/", "scr_text_slash_scr_text_gml_7830_0");
            }
            msgnextloc("\\C3", "scr_text_slash_scr_text_gml_7833_0");
            break;
        case 1259:
            if (global.choice == 0)
            {
                scr_speaker("no_name");
                msgsetloc(0, "\\M3* You want to buy something using your POINTs? That's lovely^1, Kris!/", "scr_text_slash_scr_text_gml_7841_0");
                msgnextloc("\\M0* Gotta use that vending machine though. Tenna doesn't like us..^1. touching the POINTs./%", "scr_text_slash_scr_text_gml_7842_0");
            }
            if (global.choice == 1)
            {
                with (obj_npc_ramb)
            ...
            {
                scr_speaker("no_name");
                msgsetloc(0, "* Keep your chin up^1, Kris^1! This whole house is your friend!/%", "scr_text_slash_scr_text_gml_7856_0");
            }
            break;
        case 1260:
            global.choicemsg[0] = stringsetloc("#Enter", "scr_text_slash_scr_text_gml_7863_0");
            global.choicemsg[1] = stringsetloc("#Do not", "scr_text_slash_scr_text_gml_7864_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* (Exclusive changing room for S-Rank players only!)/", "scr_text_slash_scr_text_gml_7869_0");
            msgnext("\\C2");
            break;
        case 1261:
            scr_speaker("no_name");
            ...
            break;
        case 1262:
            global.choicemsg[0] = stringsetloc("#Play", "scr_text_slash_scr_text_gml_7888_0");
            global.choicemsg[1] = stringsetloc("#Don't play", "scr_text_slash_scr_text_gml_7889_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            if (scr_flag_get(1033) == 0)
            {
                scr_flag_set(1033, 1);
                scr_speaker("no_name");
                msgsetloc(0, "* (A game system is set up^1, but strictly^1, and rules are written down...)/", "scr_text_slash_scr_text_gml_7898_0");
                scr_anyface_next("susie", "9");
                msgnextloc("\\E9* Wanna play^1, Ralsei? It's got racing.../", "scr_text_slash_scr_text_gml_7900_0");
                scr_anyface_next("ralsei", "Q");
                msgnextloc("\\EQ* M..^1. me? No^1, I'd rather just watch you two!/", "scr_text_slash_scr_text_gml_7902_0");
                scr_anyface_next("susie", 2);
                msgnextloc("\\E2* Fine. Kris^1, let's go!/", "scr_text_slash_scr_text_gml_7904_0");
            }
            else
            {
                scr_speaker("susie");
                msgsetloc(0, "\\E2* Wanna race?/", "scr_text_slash_scr_text_gml_7908_0");
            }
            msgnext("\\C2");
            break;
        case 1263:
            ...
            {
                scr_speaker("susie");
                msgsetloc(0, "\\EK* Okay^1, no one is any fun apparently./%", "scr_text_slash_scr_text_gml_7927_0");
            }
            break;
        case 1264:
            global.choicemsg[0] = stringsetloc("#Yes", "scr_text_slash_scr_text_gml_7934_0");
            global.choicemsg[1] = stringsetloc("#No", "scr_text_slash_scr_text_gml_7935_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* (It's a suspicious drawer..^1. open it?)/", "scr_text_slash_scr_text_gml_7940_0");
            msgnext("\\C2");
            break;
        case 1265:
            if (global.choice == 0)
            ...
            break;
        case 1266:
            global.choicemsg[0] = stringsetloc("#Strike a#cool pose", "scr_text_slash_scr_text_gml_7958_0");
            global.choicemsg[1] = stringsetloc("Strike a#glamorous#pose", "scr_text_slash_scr_text_gml_7959_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgset(0, "\\C2");
        ...
        case 1267:
            ...
            break;
        case 1268:
            global.choicemsg[0] = stringsetloc("#Buy", "scr_text_slash_scr_text_gml_7980_0");
            global.choicemsg[1] = stringsetloc("#Don't Buy", "scr_text_slash_scr_text_gml_7981_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            if (global.plot >= 280)
            {
                scr_speaker("no_name");
                msgsetloc(0, "* (Due to the devaluation of POINTs as currency...)/", "scr_text_slash_scr_text_gml_7988_0");
                msgnextloc("* (This machine now only accepts DARK DOLLARS.)/", "scr_text_slash_scr_text_gml_7989_0");
                msgnextloc("* (We apologize for the convenience.)/", "scr_text_slash_scr_text_gml_7990_0");
            }
            else
            {
                msgsetloc(0, "* (POINTs to ITEMs!)&* (Use the vending machine?)/", "scr_text_slash_scr_text_gml_7985_0");
            }
            msgnext("\\C2");
            break;
        case 1269:
            if (global.choice == 0)
            {
                scr_speaker("no_name");
                msgset(0, "%%");
                instance_create(camerax(), cameray(), obj_shop_vending);
                exit;
            }
            if (global.choice == 1)
            {
        ...
        case 1272:
            ...
            global.choicemsg[0] = stringsetloc("#$50 -> 10 PTs", "scr_text_slash_scr_text_gml_8050_0");
            global.choicemsg[1] = stringsetloc("#$250 -> 60 PTs", "scr_text_slash_scr_text_gml_8051_0");
            global.choicemsg[2] = stringsetloc("$1000 -> 250 PTs", "scr_text_slash_scr_text_gml_8052_0");
            global.choicemsg[3] = stringsetloc("Don't exchange", "scr_text_slash_scr_text_gml_8053_0");
            scr_speaker("no_name");
            msgsetloc(0, "* Exchange $ into POINTs?/", "scr_text_slash_scr_text_gml_8055_0");
            msgnext("\\C4");
            break;
        case 1273:
            if (global.choice == 3)
            ...
            else
            {
                ...
                if (can_afford)
                {
                    ...
                    snd_play(snd_equip);
                    scr_speaker("no_name");
                    msgsetloc(0, "* (Points exchanged.)/%", "scr_text_slash_scr_text_gml_8090_0");
                }
                else
                {
                    scr_speaker("no_name");
                    msgsetloc(0, "* (Not enough money.)/%", "scr_text_slash_scr_text_gml_8094_0");
                }
            }
            break;
        case 1274:
        ...
        case 1275:
            ...
            break;
        case 1276:
            global.choicemsg[0] = stringsetloc("#Sarcasm", "scr_text_slash_scr_text_gml_8132_0");
            global.choicemsg[1] = stringsetloc("Everything I#say is#serious", "scr_text_slash_scr_text_gml_8133_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("susie");
            msgsetloc(0, "\\E3* Heh^1, that's obviously sarcasm^1, right?/", "scr_text_slash_scr_text_gml_8137_0");
            msgnext("\\C2");
            break;
        case 1277:
            if (global.choice == 0)
            ...
            break;
        case 1278:
            global.choicemsg[0] = stringsetloc("#Yes", "scr_text_slash_scr_text_gml_8162_0");
            global.choicemsg[1] = stringsetloc("#No", "scr_text_slash_scr_text_gml_8163_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* (It's Elnina's controller. Take it?)/", "scr_text_slash_scr_text_gml_8167_0");
            msgnext("\\C2");
            break;
        case 1279:
            with (obj_ch3_GSC04B)
            ...
            scr_flag_set(1060, 1);
            global.writersnd[0] = snd_item;
            if (scr_keyitemcheck(16) == 0)
                scr_keyitemget(16);
            if (global.choice == 0)
            {
                scr_speaker("no_name");
                msgsetloc(0, "\\S0* (You can now play as Elnina.)/%", "scr_text_slash_scr_text_gml_8188_0");
            }
            if (global.choice == 1)
            {
                scr_speaker("susie");
                msgsetloc(0, "\\E4* Just take it^1, dumbass./", "scr_text_slash_scr_text_gml_8194_0");
                scr_anyface_next("no_name");
                msgnextloc("\\S0* (You were forced to unlock playing as Elnina.)/%", "scr_text_slash_scr_text_gml_8196_0");
            }
            with (obj_b3bs_console)
                array_push(playerid, "elnina");
            break;
        case 1280:
            global.choicemsg[0] = stringsetloc("#Here to#cheat", "scr_text_slash_scr_text_gml_8205_0");
            global.choicemsg[1] = stringsetloc("#Got Lost#looking for#Lancer", "scr_text_slash_scr_text_gml_8206_0");
            if (room == room_dw_b3bs_zapper_a)
            {
                global.choicemsg[0] = stringsetloc("#Fight it out", "scr_text_slash_scr_text_gml_8210_0");
                global.choicemsg[1] = stringsetloc("#Get Caught", "scr_text_slash_scr_text_gml_8211_0");
            }
            if (room == room_dw_b3bs_zapper_b)
                global.choicemsg[1] = stringsetloc("#Got Lost#looking for#the exit", "scr_text_slash_scr_text_gml_8215_0");
            if (room == room_dw_b3bs_zapper_c)
                global.choicemsg[1] = stringsetloc("#Back here to#do good deeds", "scr_text_slash_scr_text_gml_8218_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* You aren't supposed to be back here. Explain yourself!/", "scr_text_slash_scr_text_gml_8223_0");
            msgnext("\\C2");
            break;
        case 1281:
            if (global.choice == 0)
            ...
            break;
        case 1282:
            global.choicemsg[0] = stringsetloc("#Obviously", "scr_text_slash_scr_text_gml_8248_0");
            global.choicemsg[1] = stringsetloc("#No thanks", "scr_text_slash_scr_text_gml_8249_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("susie");
            msgsetloc(0, "\\E2* Y'know if you lick old screens it makes rainbows?/", "scr_text_slash_scr_text_gml_8253_0");
            msgnext("\\C2");
            break;
        case 1283:
            if (global.choice == 0)
            {
                scr_speaker("susie");
                msgsetloc(0, "\\E8* Heh^1, 'course you would know that..^1. weirdo./%", "scr_text_slash_scr_text_gml_8263_0");
            }
            if (global.choice == 1)
            {
                scr_speaker("susie");
                msgsetloc(0, "\\EH* Dude^1, I wasn't saying we do it RIGHT NOW./%", "scr_text_slash_scr_text_gml_8269_0");
            }
            break;
        case 1284:
            global.choicemsg[0] = stringset("");
        ...
        case 1287:
            ...
            break;
        case 1288:
            global.choicemsg[0] = stringsetloc("#Explain#please", "scr_text_slash_scr_text_gml_8369_0");
            global.choicemsg[1] = stringsetloc("#Let's go!", "scr_text_slash_scr_text_gml_8368_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("tenna");
            msgsetloc(0, "* Need any other instructions^1, or should we start the FINAL MATCH!?/", "scr_text_slash_scr_text_gml_8373_0");
            msgnext("\\C2");
            break;
        case 1289:
            if (global.choice == 0)
            ...
            break;
        case 1290:
            global.choicemsg[0] = stringsetloc("#Still not#ready", "scr_text_slash_scr_text_gml_8398_0");
            global.choicemsg[1] = stringsetloc("#Ready", "scr_text_slash_scr_text_gml_8399_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("ralsei");
            msgsetloc(0, "\\EJ* Kris^1, are we all ready to start Round 2?/", "scr_text_slash_scr_text_gml_8403_0");
            msgnext("\\C2");
            break;
        case 1291:
            if (global.choice == 0)
            {
                scr_speaker("susie");
                msgsetloc(0, "\\E2* Yeah^1, what's the rush^1, anyway?/%", "scr_text_slash_scr_text_gml_8413_0");
            }
            if (global.choice == 1)
            {
                with (obj_room_interstitial)
                    con = 10;
                scr_speaker("no_name");
                msgset(0, "%%");
            }
        ...
        case 1297:
            ...
            break;
        case 1298:
            global.choicemsg[0] = stringsetloc("#Buy", "scr_text_slash_scr_text_gml_8509_0");
            global.choicemsg[1] = stringsetloc("#Don't Buy", "scr_text_slash_scr_text_gml_8510_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* (POINTs to ITEMs!)&* (Use the vending machine?)/", "scr_text_slash_scr_text_gml_8514_0");
            msgnext("\\C2");
            break;
        case 1299:
            if (global.choice == 0)
            {
                scr_speaker("no_name");
                msgset(0, "%%");
                instance_create(camerax(), cameray(), obj_shop_vending_preview);
                exit;
            }
            if (global.choice == 1)
            {
        ...
        case 1300:
            instance_create(0, 0, obj_pointdisplay);
            global.choicemsg[0] = stringsetloc("#Give#1500 POINTs", "scr_text_slash_scr_text_gml_8542_0");
            global.choicemsg[1] = stringsetloc("#No thanks", "scr_text_slash_scr_text_gml_8543_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* Hey^1! Hey^1, you^1! You wanna be an S rank^1, don't you.../", "scr_text_slash_scr_text_gml_8547_0");
            msgnextloc("* Well^1, you didn't hear it from me^1, but I might know a way./", "scr_text_slash_scr_text_gml_8548_0");
            msgnextloc("* I just need 1500 POINTs./", "scr_text_slash_scr_text_gml_8549_0");
            msgnextloc("* Yeah^1, yeah. 1500 POINTs./", "scr_text_slash_scr_text_gml_8550_0");
            msgnext("\\C2");
            break;
        case 1301:
            if (global.choice == 0)
            {
                var can_afford = global.flag[1044] >= 1500;
                if (can_afford)
                {
                    global.flag[1044] -= 1500;
                ...
                {
                    scr_speaker("no_name");
                    msgsetloc(0, "* Lessee..^1. 1^1, 2^1, 3^1, 4^1, 5^1, 6..^1. Hey^1, this isn't enough!/", "scr_text_slash_scr_text_gml_8572_0");
            ...
            {
                scr_speaker("no_name");
                msgsetloc(0, "* Well^1, your loss. ..^1. or^1, I guess you won. But poorly. Right?/%", "scr_text_slash_scr_text_gml_8580_0");
            }
            break;
        case 1302:
            global.choicemsg[0] = stringsetloc("#Instructions#please", "scr_text_slash_scr_text_gml_8587_0");
            global.choicemsg[1] = stringsetloc("#Let's go", "scr_text_slash_scr_text_gml_8588_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgset(0, "\\C2");
        ...
        case 1303:
            ...
            break;
        case 1304:
            global.choicemsg[0] = stringsetloc("#Enter Code", "scr_text_slash_scr_text_gml_8616_0");
            global.choicemsg[1] = stringsetloc("#Do Not", "scr_text_slash_scr_text_gml_8617_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* (It's a door with a PARENTAL LOCK system to prevent the viewing of R-RATED MOVIES.)/", "scr_text_slash_scr_text_gml_8621_0");
            if (room == room_dw_puzzlecloset_2)
                msgsetloc(0, "* (It's a door with a PARENTAL LOCK system to prevent the viewing of MUSIC VIDEOS.)/", "scr_text_slash_scr_text_gml_8624_0");
            if (room == room_dw_puzzlecloset_3)
                msgsetloc(0, "* (It's a parental lock. It seems to be undefined.)/", "scr_text_slash_scr_text_gml_8653_0");
        ...
        case 1305:
            ...
            break;
        case 1306:
            global.choicemsg[0] = stringsetloc("#Super fun", "scr_text_slash_scr_text_gml_8650_0");
            global.choicemsg[1] = stringsetloc("#Eh", "scr_text_slash_scr_text_gml_8651_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "\\M1* Oi^1, Kris^1! How were the games^1, luv?/", "scr_text_slash_scr_text_gml_8655_0");
            msgnext("\\C2");
            break;
        case 1307:
            if (global.choice == 0)
            {
                if (scr_flag_get(1084) == 0)
                    scr_flag_set(1084, 1);
                scr_speaker("no_name");
                msgsetloc(0, "\\M2* I see^1, I see..^1. It's all well and good if you feel that way./", "scr_text_slash_scr_text_gml_8671_0");
                msgnextloc("* Ol' man Tenna's got to have SOMEONE appreciate him^1, I suppose.../%", "scr_text_slash_scr_text_gml_8672_0");
            }
            if (global.choice == 1)
            {
                if (scr_flag_get(1084) == 0)
                    scr_flag_set(1084, 2);
                var sword_route = scr_flag_get(1055) >= 3;
                global.writersnd[0] = snd_creepyjingle;
                scr_speaker("no_name");
                msgsetloc(0, "* See^1, I KNEW you wouldn't like it. Something's missing^1, right?/", "scr_text_slash_scr_text_gml_8687_0");
                if (!sword_route)
                {
                    msgnextloc("\\M2* Some action..^1. Some mystery..^1. Maybe some more..^1. freedom?/", "scr_text_slash_scr_text_gml_8693_0");
                    msgnextloc("* (Just between you and me^1, if you can get in the S-Ranker's room...)\\S0/%", "scr_text_slash_scr_text_gml_8694_0");
                }
                else
                {
                    msgnextloc("\\M2* (Good thing we've got the REAL game^1, eh^1, luv?)\\S0/%", "scr_text_slash_scr_text_gml_8701_0");
                }
            }
            break;
        case 1308:
            global.choicemsg[0] = stringsetloc("#Yes", "scr_text_slash_scr_text_gml_8714_0");
            global.choicemsg[1] = stringsetloc("#Not yet...", "scr_text_slash_scr_text_gml_8715_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("ralsei");
            msgsetloc(0, "\\EJ* Um^1, shall we go back to the stage now?/", "scr_text_slash_scr_text_gml_8719_0");
            msgnext("\\C2");
            break;
        case 1309:
            scr_speaker("no_name");
            ...
            break;
        case 1310:
            global.choicemsg[0] = stringsetloc("#Need#instructions", "scr_text_slash_scr_text_gml_8739_0");
            global.choicemsg[1] = stringsetloc("Don't need#instructions#to rock", "scr_text_slash_scr_text_gml_8740_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("tenna");
            msgsetloc(0, "* Haha^1! Just kidding^1! Anyway^1, are you ready to ROCK!?/", "scr_text_slash_scr_text_gml_8744_0");
            msgnext("\\C2");
            break;
        case 1311:
            scr_speaker("no_name");
        ...
        case 1312:
            ...
            global.choicemsg[3] = stringset("");
            scr_speaker("zapper");
            msgsetloc(0, "* You's a cheater^1, ain't ya./", "scr_text_slash_scr_text_gml_8774_0");
            msgnext("\\C2");
            break;
        case 1313:
            scr_speaker("no_name");
            ...
            if (global.choice == 0)
            {
                global.choicemsg[0] = stringsetloc("#Where I#came from", "scr_text_slash_scr_text_gml_8786_0");
                global.choicemsg[1] = stringsetloc("#Here", "scr_text_slash_scr_text_gml_8787_0");
                if (global.flag[1092] != 4)
                    global.choicemsg[2] = stringsetloc("Nowhere", "scr_text_slash_scr_text_gml_8790_0");
                scr_speaker("no_name");
                msgsetloc(0, "* Now^1, honesty^1, that'll take you somewhere./", "scr_text_slash_scr_text_gml_8793_0");
                msgnextloc("* Where you headed?/", "scr_text_slash_scr_text_gml_8794_0");
                if (global.flag[1092] != 4)
                    msgnext("\\C3");
                else
                    msgnext("\\C2");
            ...
            {
                scr_speaker("no_name");
                msgsetloc(0, "* Then we's got no business!/%", "scr_text_slash_scr_text_gml_8805_0");
                with (obj_chaseenemy_zapper)
                    con = 51;
            }
            break;
        case 1314:
            ...
            if (global.choice == 0)
            {
                var puzcheck = 0;
                if (puzcheck == 0)
                    msgsetloc(0, "* The entrance...? That can be arranged./%", "scr_text_slash_scr_text_gml_8825_0");
                if (puzcheck == 1)
                    msgsetloc(0, "* The entrance...? Well^1, it's blocked by a puzzle. Solve it and head left./%", "scr_text_slash_scr_text_gml_8829_0");
                with (obj_chaseenemy_zapper)
                {
                    roomtarg = 237;
                    global.facing = 2;
            ...
            if (global.choice == 1)
            {
                msgsetloc(0, "* That can be arranged./%", "scr_text_slash_scr_text_gml_8835_0");
                obj_chaseenemy_zapper.roomtarg = room;
            }
            if (global.choice == 2)
            {
                msgsetloc(0, "* You's was already heading that way^1, weren't ya^1, Kris?/%", "scr_text_slash_scr_text_gml_8840_0");
                obj_chaseenemy_zapper.roomtarg = 182;
            }
            break;
        case 1315:
            global.choicemsg[0] = stringsetloc("#No", "scr_text_slash_scr_text_gml_8849_0");
            global.choicemsg[1] = stringsetloc("#Yes", "scr_text_slash_scr_text_gml_8850_0");
            global.choicemsg[2] = stringsetloc("I'm a cheater", "scr_text_slash_scr_text_gml_8851_0");
            global.choicemsg[3] = stringset("");
            scr_speaker("zapper");
            msgsetloc(0, "* Da boss is lookin' for cheaters. You's ain't seen any cheaters^1, have ya?/", "scr_text_slash_scr_text_gml_8854_0");
            msgnext("\\C3");
            break;
        case 1316:
            if (global.choice == 0)
                msgsetloc(0, "* Too bad..^1. naw^1, too good./%", "scr_text_slash_scr_text_gml_8862_0");
            if (global.choice == 1)
                msgsetloc(0, "* Too good..^1. naw^1, too bad./%", "scr_text_slash_scr_text_gml_8864_0");
            if (global.choice == 2)
            {
                msgsetloc(0, "* What the -- say it in da cage!/%", "scr_text_slash_scr_text_gml_8867_0");
                obj_b3bs_jail2.con = 1;
                global.flag[1093] = 1;
            }
            break;
        case 1317:
            global.choicemsg[0] = stringsetloc("#Yes", "scr_text_slash_scr_text_gml_8879_0");
            global.choicemsg[1] = stringsetloc("#Not Yet", "scr_text_slash_scr_text_gml_8880_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("zapper");
            msgsetloc(0, "* Kris^1, all done?/", "scr_text_slash_scr_text_gml_8884_0");
            msgnext("\\C2");
            break;
        case 1318:
            if (global.choice == 0)
            {
                scr_speaker("zapper");
                if (scr_keyitemcheck(18) == 0)
                    msgsetloc(0, "* That can be arranged.../%", "scr_text_slash_scr_text_gml_8901_0");
                else
                    msgsetloc(0, "* Kris^1, what's that TICKET? Nevermind^1, hurry or Mr. Tenna's gonna get mad./%", "scr_text_slash_scr_text_gml_8890_0");
                obj_b3bs_zapper_d.con = 1;
            }
            if (global.choice == 1)
            {
                scr_speaker("zapper");
                msgsetloc(0, "* Good. I hadn't arranged the way back yet./%", "scr_text_slash_scr_text_gml_8907_0");
            }
            break;
        case 1319:
            global.choicemsg[0] = stringsetloc("#Fight#him", "scr_text_slash_scr_text_gml_8915_0");
            global.choicemsg[1] = stringsetloc("#Press his#buttons", "scr_text_slash_scr_text_gml_8916_0");
            global.choicemsg[2] = stringsetloc("Don't do anything", "scr_text_slash_scr_text_gml_8917_0");
            global.choicemsg[3] = stringset("");
            if (global.flag[1241] == 0)
            {
                scr_speaker("ralsei");
                msgsetloc(0, "\\EK* (Seems pretty suspicious to me...)/", "scr_text_slash_scr_text_gml_8920_0");
                scr_anyface_next("no_name", 0);
                msgnext("\\C3");
                global.flag[1241] = 1;
            }
        ...
        case 1320:
            ...
            break;
        case 1321:
            global.choicemsg[0] = stringsetloc("#Sign", "scr_text_slash_scr_text_gml_8959_0");
            global.choicemsg[1] = stringsetloc("#Don't", "scr_text_slash_scr_text_gml_8960_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* (Wants an autograph.)/", "scr_text_slash_scr_text_gml_8964_0");
            msgnext("\\C2");
            break;
        case 1322:
            if (global.choice == 0)
            ...
            break;
        case 1323:
            global.choicemsg[0] = stringsetloc("Buy TV#Dinner#for $250", "scr_text_slash_scr_text_gml_8993_0");
            global.choicemsg[1] = stringsetloc("#Don't", "scr_text_slash_scr_text_gml_8994_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            instance_create(0, 0, obj_moneydisplay);
            var times_talked = 0;
            ...
            var no_money = global.gold <= 0;
            if (times_talked == 0)
            {
                scr_speaker("no_name");
                msgsetloc(0, "* Kris^1! This world doesn't take cash. Instead^1, you'll earn POINTs!/", "scr_text_slash_scr_text_gml_9013_0");
                msgnextloc("* (So how about one last chance to use your $$$...?)/", "scr_text_slash_scr_text_gml_9014_0");
            }
            else
            {
                scr_speaker("no_name");
                msgsetloc(0, "* (Need any items?)/", "scr_text_slash_scr_text_gml_9018_0");
            }
            if (no_money)
            {
                msgnextloc("* ..^1. actually^1, you don't have any money./", "scr_text_slash_scr_text_gml_9070_0");
                msgnextloc("* Gee^1, ever think of saving some from your other adventures...?/%", "scr_text_slash_scr_text_gml_9071_0");
            }
            msgnext("\\C2");
            break;
        case 1324:
            if (global.choice == 0)
            {
                var can_afford = global.gold >= 250;
                if (can_afford)
                {
                    var itemgetstring = scr_itemget_anytype_text(34, "item");
                    if (noroom == 0)
                    {
                        global.gold -= 250;
                        snd_play(snd_item);
                    ...
                    {
                        scr_speaker("no_name");
                        msgsetloc(0, "* ..^1. you already have too much stuff!/%", "scr_text_slash_scr_text_gml_9078_0");
                    }
                }
                else
                {
                    scr_speaker("no_name");
                    msgsetloc(0, "* ..^1. wait^1, you don't have any money anyway./%", "scr_text_slash_scr_text_gml_9083_0");
                }
            }
            if (global.choice == 1)
            {
            ...
            break;
        case 1325:
            global.choicemsg[0] = stringsetloc("#Love", "scr_text_slash_scr_text_gml_9099_0");
            global.choicemsg[1] = stringsetloc("#Hate", "scr_text_slash_scr_text_gml_9100_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* (It's a moral choice...)/", "scr_text_slash_scr_text_gml_9105_0");
            ...
            {
                msgnextloc("* (..^1. and it seems you've already chosen.)/%", "scr_text_slash_scr_text_gml_9124_0");
                with (obj_room_teevie_sams)
                    choose_hate();
            }
            break;
        case 1326:
            ...
            break;
        case 1327:
            global.choicemsg[0] = stringsetloc("#Yes", "scr_text_slash_scr_text_gml_9131_0");
            global.choicemsg[1] = stringsetloc("...#...#Yes", "scr_text_slash_scr_text_gml_9132_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("susie");
            msgsetloc(0, "\\E2* The only ranch WE need is \"cool^1,\" right^1, Kris?/", "scr_text_slash_scr_text_gml_9137_0");
            msgnext("\\C2");
            break;
        case 1328:
            scr_speaker("susie");
            msgsetloc(0, "\\E2* Exactly./%", "scr_text_slash_scr_text_gml_9145_0");
            break;
        case 1329:
            global.choicemsg[0] = stringset("");
            global.choicemsg[1] = stringset("");
        ...
        case 1330:
            ...
            break;
        case 1331:
            global.choicemsg[0] = stringsetloc("#Playing games", "scr_text_slash_scr_text_gml_9198_0");
            global.choicemsg[1] = stringsetloc("#Nothing", "scr_text_slash_scr_text_gml_9199_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("susie");
            msgsetloc(0, "\\EK* What the hell took you so long?/", "scr_text_slash_scr_text_gml_9203_0");
            msgnext("\\C2");
            break;
        case 1332:
            scr_speaker("no_name");
            ...
            break;
        case 1333:
            global.choicemsg[0] = stringsetloc("#My rank,#my rewards?", "scr_text_slash_scr_text_gml_9220_0");
            global.choicemsg[1] = stringsetloc("#What's in#each door?", "scr_text_slash_scr_text_gml_9221_0");
            global.choicemsg[2] = stringsetloc("Don't", "scr_text_slash_scr_text_gml_9222_0");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgset(0, "\\C3");
            break;
        case 1334:
            ...
            break;
        case 1337:
            global.choicemsg[0] = stringsetloc("#Yes", "scr_text_slash_scr_text_gml_9248_0");
            global.choicemsg[1] = stringsetloc("#No", "scr_text_slash_scr_text_gml_9249_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* (The sign says \"BALL MACHINE User's Guide. Read it?\")/", "scr_text_slash_scr_text_gml_9254_0");
            msgnext("\\C2");
            break;
        case 1338:
            if (global.choice == 0)
            {
                scr_speaker("no_name");
                msgsetloc(0, "* (\"Welcome to BALL MACHINE. Insert points to gain PRIZES.\")/", "scr_text_slash_scr_text_gml_9264_0");
                msgnextloc("* (\"The minimum is 100 POINTs. MORE POINTs increase GOLD CHANCE.\")/", "scr_text_slash_scr_text_gml_9265_0");
                msgnextloc("* (\"Even if you miss GOLD PRIZE^1, next time GOLD CHANCE increases faster!\")/", "scr_text_slash_scr_text_gml_9266_0");
                msgnextloc("* (\"HIT the GOLD PRIZE^1, GOLD CHANCE will reset..^1. etc.\")/", "scr_text_slash_scr_text_gml_9267_0");
                msgnextloc("* (\"You turned to the camera and thanked Tenna for a great toy^1! Thanks^1, Tenna!\")/", "scr_text_slash_scr_text_gml_9268_0");
                msgnextloc("* (..^1. is^1, all part of what it said on the sign.)/%", "scr_text_slash_scr_text_gml_9269_0");
            }
            else
            {
                scr_speaker("no_name");
                msgsetloc(0, "* (The sign says \"You didn't choose to read the User's Guide. Avert eyes!\")/%", "scr_text_slash_scr_text_gml_9273_0");
            }
            break;
        case 1339:
            global.choicemsg[0] = stringsetloc("#Check scores", "scr_text_slash_scr_text_gml_9281_0");
            global.choicemsg[1] = stringsetloc("#Tips and Tricks", "scr_text_slash_scr_text_gml_9282_0");
            global.choicemsg[2] = stringsetloc("Nothing", "scr_text_slash_scr_text_gml_9283_0");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* (It's a poster for the COOKING CHALLENGE!)/", "scr_text_slash_scr_text_gml_9287_0");
            msgnext("\\C3");
            break;
        case 1340:
            if (global.choice == 0)
            {
                scr_get_high_score_text(1193, 1194, "");
            }
            else if (global.choice == 1)
            {
                scr_speaker("no_name");
                msgsetloc(0, "* (Here are some tips for the HIGH SCORES.)/", "scr_text_slash_scr_text_gml_9300_0");
                msgnextloc("* (The taller a stack you throw^1, the more points you get!)/", "scr_text_slash_scr_text_gml_9301_0");
                msgnextloc("* (SPECIAL GUESTS are worth more points!)/", "scr_text_slash_scr_text_gml_9302_0");
                msgnextloc("* (Jumping over fire is worth 2 points...)/", "scr_text_slash_scr_text_gml_9303_0");
                msgnextloc("* (And^1, catching food while jumping is worth 1 point!)/%", "scr_text_slash_scr_text_gml_9304_0");
            }
            else
            {
                scr_speaker("no_name");
            ...
            break;
        case 1341:
            global.choicemsg[0] = stringsetloc("#Check scores", "scr_text_slash_scr_text_gml_9316_0");
            global.choicemsg[1] = stringsetloc("#Tips and Tricks", "scr_text_slash_scr_text_gml_9317_0");
            global.choicemsg[2] = stringsetloc("Nothing", "scr_text_slash_scr_text_gml_9318_0");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* (It's a poster for the ROCK VIDEO!)/", "scr_text_slash_scr_text_gml_9322_0");
            msgnext("\\C3");
            break;
        case 1342:
            if (global.choice == 0)
            {
                scr_get_high_score_text(1195, 1196, "");
            }
            else if (global.choice == 1)
            {
                scr_speaker("no_name");
                msgsetloc(0, "* (Tips and tricks to ROCK OUT!)/", "scr_text_slash_scr_text_gml_9335_0");
                msgnextloc("* (Perfect timing means extra points^1! A GOLD LIGHT means you nailed the note!)/", "scr_text_slash_scr_text_gml_9336_0");
                var ver = 0;
                if (global.lang == "ja" && scr_is_switch_os())
                    ver = 1;
                if (ver == 0)
                    msgnextloc("* (LEFT and RIGHT can be used to play notes as well!)/", "scr_text_slash_scr_text_gml_9337_0");
                else
                    msgnext("＊ (「左」または「右」ボタンでも\n　 演奏OK！)/");
                msgnextloc("* (Make sure to HOLD DOWN THE BUTTON for long notes.)/%", "scr_text_slash_scr_text_gml_9338_0");
            }
            else
            {
                scr_speaker("no_name");
            ...
            break;
        case 1343:
            global.choicemsg[0] = stringsetloc("#Check scores", "scr_text_slash_scr_text_gml_9350_0");
            global.choicemsg[1] = stringsetloc("#Tips and Tricks", "scr_text_slash_scr_text_gml_9351_0");
            global.choicemsg[2] = stringsetloc("Nothing", "scr_text_slash_scr_text_gml_9352_0");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* (It's a poster for the MONSTER MOVIE!)/", "scr_text_slash_scr_text_gml_9356_0");
            msgnext("\\C3");
            break;
        case 1344:
            if (global.choice == 0)
            {
                var _sec = string(global.flag[1234]);
                var _min = 0;
                var _str = "";
                repeat (9)
                {
                ...
                if (_sec < 10)
                    _str = string(_min) + ":0" + string(_sec);
                else
                    _str = string(_min) + ":" + string(_sec);
                scr_get_high_score_text(1197, 1198, _str);
            }
            else if (global.choice == 1)
            {
                scr_speaker("no_name");
                msgsetloc(0, "* (It's a giant monster movie^1! Bash everything!)/", "scr_text_slash_scr_text_gml_9378_0");
                msgnextloc("* (Destroy all houses in one attack for BONUS POINTs!)/", "scr_text_slash_scr_text_gml_9379_0");
                msgnextloc("* (Survive at the end for the highest score...!)/", "scr_text_slash_scr_text_gml_9380_0");
                msgnextloc("* (There are no rewards for getting a high score though.)/%", "scr_text_slash_scr_text_gml_9381_0");
            }
            else
            {
                scr_speaker("no_name");
            ...
            break;
        case 1345:
            global.choicemsg[0] = stringsetloc("#Play#COOKING SHOW", "scr_text_slash_scr_text_gml_9393_0");
            global.choicemsg[1] = stringsetloc("#Quit", "scr_text_slash_scr_text_gml_9394_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* (It's the door to the COOKING SHOW^1! Play it!?)/", "scr_text_slash_scr_text_gml_9399_0");
            msgnext("\\C2");
            break;
        case 1346:
            if (global.choice == 0)
            ...
            break;
        case 1347:
            global.choicemsg[0] = stringsetloc("#Play#ROCK VIDEO", "scr_text_slash_scr_text_gml_9429_0");
            global.choicemsg[1] = stringsetloc("#Quit", "scr_text_slash_scr_text_gml_9430_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* (It's the door to the ROCK VIDEO^1! Play it!?)/", "scr_text_slash_scr_text_gml_9435_0");
            msgnext("\\C2");
            break;
        case 1348:
            if (global.choice == 0)
            ...
            break;
        case 1349:
            global.choicemsg[0] = stringsetloc("#Normal#Mode", "scr_text_slash_scr_text_gml_9465_0");
            global.choicemsg[1] = stringsetloc("#Difficult#Mode", "scr_text_slash_scr_text_gml_9466_0");
            global.choicemsg[2] = stringsetloc("Don't play", "scr_text_slash_scr_text_gml_9467_0");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* (Which mode will you play on?)/", "scr_text_slash_scr_text_gml_9471_0");
            msgnext("\\C3");
            break;
        case 1350:
            if (global.choice < 2)
            ...
            break;
        case 1351:
            global.choicemsg[0] = stringsetloc("#Pay#500 points", "scr_text_slash_scr_text_gml_9503_0");
            global.choicemsg[1] = stringsetloc("#Don't", "scr_text_slash_scr_text_gml_9504_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            instance_create(0, 0, obj_pointdisplay);
            scr_speaker("no_name");
            msgsetloc(0, "* Hey^1, hey^1! This here's an extra special game..^1. It's LOCKED^1, you know!/", "scr_text_slash_scr_text_gml_9511_0");
            msgnextloc("* That is..^1. unless you pay 500 POINTs./", "scr_text_slash_scr_text_gml_9512_0");
            msgnext("\\C2");
            break;
        case 1352:
            if (global.choice == 0)
            {
                with (obj_room_ranking_a)
                    unlock_susiezilla();
                snd_play(snd_equip);
                scr_speaker("no_name");
                msgsetloc(0, "* (You handed over 500 POINTs.)/%", "scr_text_slash_scr_text_gml_9526_0");
            }
            else
            {
                scr_speaker("no_name");
                msgsetloc(0, "* Seriously? A REAL gamer would pay ANY transaction!/%", "scr_text_slash_scr_text_gml_9530_0");
            }
            break;
        case 1353:
            var game_text = stringsetloc("#Play#MYSTERY GAME", "scr_text_slash_scr_text_gml_9573_0");
            if (scr_flag_get(1219) == 1)
                game_text = stringsetloc("#Play#MONSTER MOVIE", "scr_text_slash_scr_text_gml_9577_0_b");
            global.choicemsg[0] = game_text;
            global.choicemsg[1] = stringsetloc("#Quit", "scr_text_slash_scr_text_gml_9541_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            var game_name = (scr_flag_get(1219) == 0) ? stringsetloc("MYSTERY GAME", "scr_text_slash_scr_text_gml_9538_0") : stringsetloc("MONSTER MOVIE", "scr_text_slash_scr_text_gml_9538_1");
            scr_speaker("no_name");
            msgsetsubloc(0, "* (It's the door to the ~1^1! Play it!?)/", game_name, "scr_text_slash_scr_text_gml_9546_0");
            msgnext("\\C2");
            break;
        case 1354:
            if (global.choice == 0)
            ...
            break;
        case 1355:
            global.choicemsg[0] = stringsetloc("#Enter", "scr_text_slash_scr_text_gml_9576_0");
            global.choicemsg[1] = stringsetloc("#Do not", "scr_text_slash_scr_text_gml_9577_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* (It's a manhole...)/", "scr_text_slash_scr_text_gml_9582_0");
            msgnext("\\C2");
            break;
        case 1356:
            if (global.choice == 0)
            {
                with (obj_room_ranking_z)
                    enter_manhole();
                scr_speaker("no_name");
                msgsetloc(0, "* (You went in the manhole...)/%", "scr_text_slash_scr_text_gml_9594_0");
            }
            else
            {
                scr_speaker("no_name");
            ...
            break;
        case 1357:
            global.choicemsg[0] = stringsetloc("#Enter", "scr_text_slash_scr_text_gml_9606_0");
            global.choicemsg[1] = stringsetloc("#Do not", "scr_text_slash_scr_text_gml_9607_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* (The door says \"Exclusive Z-RANK changing room!\")/", "scr_text_slash_scr_text_gml_9612_0");
            msgnext("\\C2");
            break;
        case 1358:
            if (global.choice == 0)
            {
                with (obj_room_ranking_z_hallway)
                    enter_door();
                scr_speaker("no_name");
                msgset(0, "%%");
            }
            ...
            break;
        case 1359:
            global.choicemsg[0] = stringsetloc("#Help or#Don't Help", "scr_text_slash_scr_text_gml_9636_0");
            global.choicemsg[1] = stringsetloc("#Pick#him up", "scr_text_slash_scr_text_gml_9637_0");
            global.choicemsg[2] = stringsetloc("No response", "scr_text_slash_scr_text_gml_9638_0");
            global.choicemsg[3] = stringset("");
            scr_speaker("lancer");
            msgsetloc(0, "\\E2* Susie^1! Blue Kris^1! I'm doing my Hurricane Attack. Want to help!?/", "scr_text_slash_scr_text_gml_9642_0");
            msgnext("\\C3");
            break;
        case 1360:
            if (global.choice == 0)
            {
                with (obj_dw_ch3_lancer_spin)
                    toggle_help();
                scr_speaker("susie");
                msgsetloc(0, "\\E2* Obviously./%", "scr_text_slash_scr_text_gml_9654_0");
            }
            else if (global.choice == 1)
            {
                with (obj_dw_ch3_lancer_spin)
            ...
            {
                scr_speaker("lancer");
                msgsetloc(0, "\\E2* Spin^1, spin^1, spin^1, spin^1, spin^1, spin^1, spin^1, spin.../%", "scr_text_slash_scr_text_gml_9664_0");
            }
            break;
        case 1361:
            global.choicemsg[0] = stringsetloc("#See what#Susie's doing", "scr_text_slash_scr_text_gml_9672_0");
            global.choicemsg[1] = stringsetloc("#Let's just#chill dude", "scr_text_slash_scr_text_gml_9673_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("ralsei");
            msgsetloc(0, "\\EJ* And just watch from here...?/", "scr_text_slash_scr_text_gml_9678_0");
            msgnext("\\C2");
            break;
        case 1362:
            scr_speaker("no_name");
            ...
            break;
        case 1363:
            global.choicemsg[0] = stringsetloc("#Eyes closed", "scr_text_slash_scr_text_gml_9701_0");
            global.choicemsg[1] = stringsetloc("#Eyes open", "scr_text_slash_scr_text_gml_9702_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("ralsei");
            msgsetloc(0, "\\EK* Like..^1. chill with our eyes closed?/", "scr_text_slash_scr_text_gml_9707_0");
            msgnext("\\C2");
            break;
        case 1364:
            scr_speaker("no_name");
            ...
            break;
        case 1365:
            global.choicemsg[0] = stringsetloc("#Your face", "scr_text_slash_scr_text_gml_9730_0");
            global.choicemsg[1] = stringsetloc("#No", "scr_text_slash_scr_text_gml_9731_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("ralsei");
            msgsetloc(0, "\\EK* Would you..^1. like to talk about something?/", "scr_text_slash_scr_text_gml_9736_0");
            msgnext("\\C2");
            break;
        case 1366:
            scr_speaker("no_name");
            ...
            else
            {
                with (obj_room_interstitial)
                    end_sequence();
                scr_speaker("ralsei");
                msgsetloc(0, "\\EJ* ..^1. umm^1, okay!/%", "scr_text_slash_scr_text_gml_9754_0");
            }
            break;
        case 1367:
            global.choicemsg[0] = stringsetloc("#Seen it#before", "scr_text_slash_scr_text_gml_9762_0");
            global.choicemsg[1] = stringsetloc("#Cute", "scr_text_slash_scr_text_gml_9763_0");
            global.choicemsg[2] = stringsetloc("Unique", "scr_text_slash_scr_text_gml_9764_0");
            global.choicemsg[3] = stringset("");
            scr_speaker("ralsei");
            msgsetloc(0, "\\ED* H-huh? M..^1. My face...?/", "scr_text_slash_scr_text_gml_9768_0");
            msgnext("\\C3");
            break;
        case 1368:
            scr_speaker("no_name");
            ...
            break;
        case 1369:
            global.choicemsg[0] = stringsetloc("#Talking", "scr_text_slash_scr_text_gml_9794_0");
            global.choicemsg[1] = stringsetloc("Trying to#close eyes and#think about#Susie", "scr_text_slash_scr_text_gml_9795_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("susie");
            msgsetloc(0, "\\EK* So what the hell were you two doing?/", "scr_text_slash_scr_text_gml_9800_0");
            msgnext("\\C2");
            break;
        case 1370:
            scr_speaker("no_name");
            ...
            break;
        case 1371:
            global.choicemsg[0] = stringsetloc("#He's fun", "scr_text_slash_scr_text_gml_9817_0");
            global.choicemsg[1] = stringsetloc("#He sucks", "scr_text_slash_scr_text_gml_9818_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgset(0, "\\C2");
        ...
        case 1372:
            ...
            break;
        case 1373:
            global.choicemsg[0] = stringsetloc("#Let's go", "scr_text_slash_scr_text_gml_9839_0");
            global.choicemsg[1] = stringsetloc("#Wait", "scr_text_slash_scr_text_gml_9840_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("susie");
            msgsetloc(0, "\\ED* ..^1. we gotta tell Tenna this is the last game./", "scr_text_slash_scr_text_gml_9845_0");
            msgnext("\\C2");
            break;
        case 1374:
            with (obj_room_interstitial)
            ...
            {
                scr_speaker("susie");
                msgsetloc(0, "\\ED* Yeah.../%", "scr_text_slash_scr_text_gml_9857_0");
            }
            else
            {
                scr_speaker("susie");
                msgsetloc(0, "\\ED* Uh^1, okay./%", "scr_text_slash_scr_text_gml_9861_0");
            }
            break;
        case 1375:
            global.choicemsg[0] = stringsetloc("#Let me talk", "scr_text_slash_scr_text_gml_9869_0");
            global.choicemsg[1] = stringsetloc("#Nah", "scr_text_slash_scr_text_gml_9870_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("susie");
            msgsetloc(0, "\\E6* ..^1. huh? Kris^1, you really want to talk to Tenna?/", "scr_text_slash_scr_text_gml_9875_0");
            msgnext("\\C2");
            break;
        case 1376:
            with (obj_room_interstitial)
            ...
            {
                scr_speaker("susie");
                msgsetloc(0, "\\ED* Whatever you wanna do^1, I guess.../%", "scr_text_slash_scr_text_gml_9887_0");
            }
            else
            {
                scr_speaker("susie");
                msgsetloc(0, "\\ED* ..^1. yeah./%", "scr_text_slash_scr_text_gml_9891_0");
            }
            break;
        case 1377:
            global.choicemsg[0] = stringsetloc("#Lanino", "scr_text_slash_scr_text_gml_9899_0");
            global.choicemsg[1] = stringsetloc("#Nothing", "scr_text_slash_scr_text_gml_9900_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* Oh^1, you three^1! It's me^1, Elnina^1! I've never felt more moisturized!/", "scr_text_slash_scr_text_gml_9905_0");
            msgnextloc("* The single life's never felt this cool and collected^1! Ask me about anything!/", "scr_text_slash_scr_text_gml_9906_0");
            msgnext("\\C2");
            break;
        case 1378:
            scr_speaker("no_name");
            ...
            break;
        case 1379:
            global.choicemsg[0] = stringsetloc("You're#strong and#independent", "scr_text_slash_scr_text_gml_9929_0");
            global.choicemsg[1] = stringsetloc("Your#forecast is#love", "scr_text_slash_scr_text_gml_9930_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* Without him to balance me^1, my only forecast is rain..^1. running down my face./", "scr_text_slash_scr_text_gml_9935_0");
            msgnext("\\C2");
            break;
        case 1380:
            with (obj_room_green_room)
            ...
            break;
        case 1381:
            global.choicemsg[0] = stringsetloc("#Weather#report", "scr_text_slash_scr_text_gml_9952_0");
            global.choicemsg[1] = stringsetloc("#Nothing", "scr_text_slash_scr_text_gml_9953_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* Oh^1, you three^1! It is I^1, Lanino. The Green Room was^1, BUSY^1, so I'm in here./", "scr_text_slash_scr_text_gml_9958_0");
            msgnextloc("* Need any^1, ahem^1, assistance from a brave and independent moon?/", "scr_text_slash_scr_text_gml_9959_0");
            msgnext("\\C2");
            break;
        case 1382:
            scr_speaker("no_name");
            ...
            break;
        case 1383:
            global.choicemsg[0] = stringsetloc("You're#strong and#independent", "scr_text_slash_scr_text_gml_9982_0");
            global.choicemsg[1] = stringsetloc("Your#forecast is#love", "scr_text_slash_scr_text_gml_9983_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* Without her moisture^1, my heart and skin have become so..^1. so^1, dry./", "scr_text_slash_scr_text_gml_9988_0");
            msgnext("\\C2");
            break;
        case 1384:
            with (obj_room_ranking_hub)
            ...
            break;
        case 1385:
            global.choicemsg[0] = stringsetloc("#Ask Susie how#she's doing", "scr_text_slash_scr_text_gml_10005_0");
            global.choicemsg[1] = stringsetloc("#Ask Ralsei how#he's doing", "scr_text_slash_scr_text_gml_10006_0");
            global.choicemsg[2] = stringsetloc("Don't", "scr_text_slash_scr_text_gml_10007_0");
            global.choicemsg[3] = stringset("");
            scr_speaker("ralsei");
            msgsetloc(0, "\\EI* (I wonder if you should..^1. ask Susie how she's doing...?)/", "scr_text_slash_scr_text_gml_10011_0");
            msgnext("\\C3");
            break;
        case 1386:
            scr_speaker("no_name");
            msgset(0, "%%");
            with (obj_room_puzzle_closet_1a)
                answer_question(global.choice);
            break;
        case 1387:
            global.choicemsg[0] = stringsetloc("#I'm not#a dream", "scr_text_slash_scr_text_gml_10028_0");
            global.choicemsg[1] = stringsetloc("Your#friendships#are real", "scr_text_slash_scr_text_gml_10029_0");
            global.choicemsg[2] = stringsetloc("Sucks to be you", "scr_text_slash_scr_text_gml_10030_0");
            global.choicemsg[3] = stringset("");
            scr_speaker("susie");
            msgsetloc(0, "\\ET* (..^1. doesn't mess me up so much.)/", "scr_text_slash_scr_text_gml_10034_0");
            msgnext("\\C3");
            break;
        case 1388:
            scr_speaker("no_name");
            ...
            break;
        case 1389:
            global.choicemsg[0] = stringsetloc("#It's ok to#take it easy", "scr_text_slash_scr_text_gml_10051_0");
            global.choicemsg[1] = stringsetloc("#Stay on task", "scr_text_slash_scr_text_gml_10052_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("ralsei");
            msgsetloc(0, "\\ED* I accidentally forgot about everything for a moment./", "scr_text_slash_scr_text_gml_10057_0");
            msgnext("\\C2");
            break;
        case 1390:
            scr_speaker("no_name");
            ...
            break;
        case 1391:
            global.choicemsg[0] = stringsetloc("#I'm not going#with her", "scr_text_slash_scr_text_gml_10074_0");
            global.choicemsg[1] = stringsetloc("#I'm saying#it's from me", "scr_text_slash_scr_text_gml_10075_0");
            global.choicemsg[2] = stringsetloc("Of course", "scr_text_slash_scr_text_gml_10076_0");
            global.choicemsg[3] = stringset("");
            scr_speaker("ralsei");
            msgsetloc(0, "\\EQ* ..^1. and tell Susie it was from me...?/", "scr_text_slash_scr_text_gml_10080_0");
            msgnext("\\C3");
            break;
        case 1392:
            scr_speaker("no_name");
            ...
            break;
        case 1393:
            global.choicemsg[0] = stringsetloc("#Noelle", "scr_text_slash_scr_text_gml_10097_0");
            global.choicemsg[1] = stringsetloc("#Ralsei or bust", "scr_text_slash_scr_text_gml_10098_0");
            global.choicemsg[2] = stringsetloc("Berdly", "scr_text_slash_scr_text_gml_10099_0");
            global.choicemsg[3] = stringsetloc("Not going", "scr_text_slash_scr_text_gml_10100_0");
            scr_speaker("ralsei");
            msgsetloc(0, "\\EL* H..^1. huh? Kris^1, but.../", "scr_text_slash_scr_text_gml_10103_0");
            msgnextloc("\\EK* Who..^1. are you intending to go with...?/", "scr_text_slash_scr_text_gml_10104_0");
            msgnext("\\C4");
            break;
        case 1394:
            scr_speaker("no_name");
            ...
            break;
        case 1395:
            global.choicemsg[0] = stringsetloc("#Yes", "scr_text_slash_scr_text_gml_10121_0");
            global.choicemsg[1] = stringsetloc("#No", "scr_text_slash_scr_text_gml_10122_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            var _challenge_text = (scr_flag_get(1080) > 2) ? stringsetloc("* CHALLENGE AGAIN!?/", "scr_text_slash_scr_text_gml_10127_0") : stringsetloc("* Do you want to CHALLENGE AGAIN!?/", "scr_text_slash_scr_text_gml_10127_1");
            scr_speaker("tenna");
            msgset(0, _challenge_text);
            msgnext("\\C2");
            break;
        case 1396:
            scr_speaker("no_name");
            msgset(0, "%%");
            with (obj_gameover_susiezilla)
                con = 5;
            break;
        case 1397:
            global.choicemsg[0] = stringsetloc("#Hear more", "scr_text_slash_scr_text_gml_10147_0");
            global.choicemsg[1] = stringsetloc("#Enough", "scr_text_slash_scr_text_gml_10148_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgset(0, "\\C2");
        ...
        case 1398:
            ...
            break;
        case 1399:
            global.choicemsg[0] = stringsetloc("#Hear more", "scr_text_slash_scr_text_gml_10169_0");
            global.choicemsg[1] = stringsetloc("#No more", "scr_text_slash_scr_text_gml_10170_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgset(0, "\\C2");
        ...
        case 1400:
            ...
            break;
        case 1401:
            global.choicemsg[0] = stringsetloc("#Hear more", "scr_text_slash_scr_text_gml_10191_0");
            global.choicemsg[1] = stringsetloc("#Please no more", "scr_text_slash_scr_text_gml_10192_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgset(0, "\\C2");
        ...
        case 1402:
            ...
            break;
        case 1403:
            global.choicemsg[0] = stringsetloc("#Yes", "scr_text_slash_scr_text_gml_10213_0");
            global.choicemsg[1] = stringsetloc("#No", "scr_text_slash_scr_text_gml_10214_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* Don't bother^1, Kris. Ramb's already turned to stone a bit ago.../", "scr_text_slash_scr_text_gml_10219_0");
            msgnextloc("* He was a plug^1, but because you played with him like any other toy^1, it made him feel special./", "scr_text_slash_scr_text_gml_10220_0");
            msgnextloc("* Might have given him a little bit of an ego^1, in fact.../", "scr_text_slash_scr_text_gml_10221_0");
            msgnextloc("* Wanna hear more?/", "scr_text_slash_scr_text_gml_10222_0");
            msgnext("\\C2");
            break;
        case 1404:
            if (global.choice == 0)
            {
                if (scr_flag_get(1239) < 2)
                {
                    scr_flag_set(1239, 2);
                    scr_speaker("no_name");
                    msgsetloc(0, "* Always condescending to any plan^1, saying \"what's best for Kris?\"/", "scr_text_slash_scr_text_gml_10236_0");
                    msgnextloc("* Couldn't get rid of him^1, so Tenna made him \"work the stand\".../", "scr_text_slash_scr_text_gml_10237_0");
                    msgnextloc("* Us from Card Castle fit in fine. Him? He never really belonged./", "scr_text_slash_scr_text_gml_10238_0");
                    msgnextloc("* His first day at this stand^1, he joked \"how about the usual?\"..^1. no one laughed!/", "scr_text_slash_scr_text_gml_10239_0");
                    msgnextloc("* Mixing drinks alone for himself^1, he wasn't allowed to handle the points.../", "scr_text_slash_scr_text_gml_10240_0");
                    msgnextloc("* No one will shed a tear for him. Inside^1, he was probably stone already./%", "scr_text_slash_scr_text_gml_10241_0");
                }
                else
                {
                    scr_speaker("no_name");
                    msgsetloc(0, "* Ramb..^1. well^1, he was like Tenna^1, I guess./", "scr_text_slash_scr_text_gml_10245_0");
                    msgnextloc("* Two guys trapped in the past..^1. just different ones./%", "scr_text_slash_scr_text_gml_10246_0");
                }
            }
            else
            {
                scr_speaker("no_name");
                msgsetloc(0, "* Well^1, that's a relief./%", "scr_text_slash_scr_text_gml_10251_0");
            }
            break;
        case 1405:
            instance_create(0, 0, obj_pointdisplay);
            global.choicemsg[0] = stringsetloc("#50 PTs -> $50", "scr_text_slash_scr_text_gml_10261_0");
            global.choicemsg[1] = stringsetloc("#200 PTs -> $250", "scr_text_slash_scr_text_gml_10262_0");
            global.choicemsg[2] = stringsetloc("1000 PTs -> $1500", "scr_text_slash_scr_text_gml_10263_0");
            global.choicemsg[3] = stringsetloc("Don't exchange", "scr_text_slash_scr_text_gml_10264_0");
            scr_speaker("no_name");
            msgsetloc(0, "* Exchange POINTs into $?/", "scr_text_slash_scr_text_gml_10266_0");
            msgnext("\\C4");
            break;
        case 1406:
            if (global.choice == 3)
            ...
            else
            {
                ...
                var can_afford = global.flag[1044] >= cost;
                if (can_afford)
                {
                    global.gold += dollars;
                    global.flag[1044] -= cost;
                    snd_play(snd_equip);
                    scr_speaker("no_name");
                    msgsetloc(0, "* (Points exchanged.)/%", "scr_text_slash_scr_text_gml_10302_0");
                }
                else
                {
                    scr_speaker("no_name");
                    msgsetloc(0, "* (Not enough points.)/%", "scr_text_slash_scr_text_gml_10306_0");
                }
            }
            break;
        case 1407:
            instance_create(0, 0, obj_moneydisplay);
            global.choicemsg[0] = stringsetloc("#Buy 1 for $300", "scr_text_slash_scr_text_gml_10324_0");
            global.choicemsg[1] = stringsetloc("#Buy 3 for $800", "scr_text_slash_scr_text_gml_10325_0");
            global.choicemsg[2] = stringsetloc("Nope", "scr_text_slash_scr_text_gml_10326_0");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            if (scr_flag_get(1250) == 0)
            {
                scr_flag_set(1250, 1);
                if (scr_ch3_violencecheck() < 3)
                {
                    msgsetloc(0, "* Been a while^1! I got caught smuggling TV Dinners for DARK DOLLARS./", "scr_text_slash_scr_text_gml_10334_0");
                    msgnextloc("* But that hasn't stopped me. Wanna buy a TV Dinner?/", "scr_text_slash_scr_text_gml_10335_0");
                }
                else
                {
                    msgsetloc(0, "* You're the jerk wanted for violence^1, right?/", "scr_text_slash_scr_text_gml_10355_0");
                    msgnextloc("* ..^1. heh^1, I can't believe I'm dealing with a criminal./", "scr_text_slash_scr_text_gml_10356_0");
                    msgnextloc("* How about it? Want to buy a TV Dinner?/", "scr_text_slash_scr_text_gml_10357_0");
                }
            }
            else
            {
                msgsetloc(0, "* TV Dinner?/", "scr_text_slash_scr_text_gml_10338_0");
            }
            msgnext("\\C3");
            break;
        case 1408:
            ...
            else
            {
                ...
                {
                    var itemgetstring = "";
                    var has_room_amount = 0;
                    for (var i = 0; i < amount; i++)
                    {
                        itemgetstring = scr_itemget_anytype_text(34, "item");
                        if (noroom == 0)
                            has_room_amount++;
                    }
                    if (has_room_amount == amount)
                    {
                        global.gold -= cost;
                        snd_play(snd_item);
                        scr_speaker("no_name");
                    ...
                    else if (has_room_amount == 0)
                    {
                        scr_speaker("no_name");
                        msgsetloc(0, "* ..^1. you already have too much stuff!/%", "scr_text_slash_scr_text_gml_10387_0");
                    }
                    else
                    {
                        global.gold -= cost;
                        scr_speaker("no_name");
                        msgsetloc(0, "* Hey^1! Looks like you couldn't carry all 3./", "scr_text_slash_scr_text_gml_10393_0");
                        msgnextloc("* That's okay..^1. I'll still keep your money anyway./", "scr_text_slash_scr_text_gml_10394_0");
                        msgnextloc("* ..^1. what? Hey^1, look who you're doing business with./%", "scr_text_slash_scr_text_gml_10395_0");
                    }
                }
                else
                {
                    scr_speaker("no_name");
                    msgsetloc(0, "* ..^1. wait^1, you don't have any money anyway./%", "scr_text_slash_scr_text_gml_10400_0");
                }
            }
            break;
        case 1409:
            ...
            scr_speaker("no_name");
            msgsetloc(0, "* (It's a door.^1)&* (Where will you go?)/", "scr_text_slash_scr_text_gml_10414_0");
            msgnext("\\C4 ");
            break;
        case 1410:
        ...
        case 1411:
            scr_speaker("no_name");
            msgsetloc(0, "* (You tried to use the console^1, but nothing happened.)/%", "scr_text_slash_scr_text_gml_10486_0");
            break;
        case 1412:
            global.choicemsg[0] = stringsetloc("#Read it", "scr_text_slash_scr_text_gml_10492_0");
            global.choicemsg[1] = stringsetloc("#Don't read it", "scr_text_slash_scr_text_gml_10493_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("ralsei");
            msgsetloc(0, "\\EL* Huh? It's a \"reminder manual\" I was revising.../", "scr_text_slash_scr_text_gml_10498_0");
            msgnextloc("\\EK* How'd it get here^1, exactly?/", "scr_text_slash_scr_text_gml_10499_0");
            msgnext("\\C2 ");
            break;
        case 1413:
            if (global.choice == 0)
            {
                scr_speaker("no_name");
                msgsetloc(0, "* (SPARE enemies whose names become \\cYYELLOW\\cW!)/", "scr_text_slash_scr_text_gml_10509_0");
                msgnextloc("* (Use PACIFY on TIRED enemies whose names are \\cBBLUE\\cW!)/", "scr_text_slash_scr_text_gml_10510_0");
                msgnextloc("* (And..^1. remember Susie and Ralsei's S-Action and R-Action^1, too!)/%", "scr_text_slash_scr_text_gml_10511_0");
            }
            else
            {
                scr_speaker("no_name");
            ...
            break;
        case 1457:
            return stringsetloc("A tea that has deteriorated after a short while#due to its poor craftsmanship. +10HP", "scr_text_slash_scr_text_gml_10537_0");
            break;
        case 1458:
            return stringsetloc("RottenTea", "scr_text_slash_scr_text_gml_10542_0");
            break;
        case 1459:
            return stringsetloc("Heals#10HP", "scr_text_slash_scr_text_gml_10547_0");
            break;
        case 1460:
            return stringsetloc("Yuck.", "scr_text_slash_scr_text_gml_10552_0");
            break;
        case 1461:
            return stringsetloc("Um?", "scr_text_slash_scr_text_gml_10557_0");
            break;
        case 1462:
            return stringsetloc("No flavor... anymore.", "scr_text_slash_scr_text_gml_10562_0");
            break;
        case 1463:
            return msgsetsubloc(0, "* ~1 used the ROTTEN TEA!/%", global.charname[global.char[caster]], "scr_text_slash_scr_text_gml_10567_0");
            break;
        case 5000:
