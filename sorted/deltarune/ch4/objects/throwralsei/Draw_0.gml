...
if (angledraw == 1)
{
    if (throwready == 1)
    {
        ...
        {
            fr = 2;
            d_circle(rx + (lx * ((i * fr) + fro)), (ry + (ly * ((i * fr) + fro)) + ralyoff[(i * fr) + fro]) - 20, 4, 0);
            d_line_width(rx + (lx * ((i * fr) + fro)), (ry + (ly * ((i * fr) + fro)) + ralyoff[(i * fr) + fro]) - 20, rx + (lx * (((i + 1) * fr) + fro)), (ry + (ly * (((i + 1) * fr) + fro)) + ralyoff[((i + 1) * fr) + fro]) - 20, 2);
