if (room != room_board_1_sword)
{
    ...
    if (myinteract == 3)
    {
        ...
        {
            scr_speaker("no_name");
            msgsetloc(0, "IT'S A BEAUTIFUL LITTLE SPRING./%", "obj_board_smallpond_slash_Step_0_gml_34_0");
        }
        else
        {
            scr_speaker("no_name");
            msgsetloc(0, "IT'S A DRY^1, SAD PIT./%", "obj_board_smallpond_slash_Step_0_gml_39_0");
        }
        bw_make();
        myinteract = 5;
    }
