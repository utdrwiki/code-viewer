scr_spritecenter_x = function(argument0) //gml_Script_scr_spritecenter_x
{
    ...
    return (argument0.x + lengthdir_x(_spriteCenterLen, (_spriteCenterDir + argument0.image_angle)));
}
