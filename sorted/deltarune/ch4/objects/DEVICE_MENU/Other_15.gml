...
_NEWCH4BOSS = ini_read_real(scr_ini_chapter(global.chapter, MENUCOORD[2]), "Ch4Boss", 0);
_NEWSIDEB = ini_read_real(scr_ini_chapter(global.chapter, MENUCOORD[2]), "SideB", 0);
...
ini_write_real(scr_ini_chapter(global.chapter, MENUCOORD[3]), "Ch4Boss", _NEWCH4BOSS);
ini_write_real(scr_ini_chapter(global.chapter, MENUCOORD[3]), "SideB", _NEWSIDEB);
