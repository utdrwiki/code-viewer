...
if (global.bmenuno == 1 || global.bmenuno == 3 || global.bmenuno == 11 || global.bmenuno == 12 || global.bmenuno == 13)
{
    ...
    if (global.myfight == 0)
    {
        ...
        if (danceCounter == 1)
        {
            draw_text_ext_transformed(((__view_get((0 << 0), 0) + 258) + xoffset), (((__view_get((1 << 0), 0) + 369) + yoffset) + 30), stringsetloc("Dancing!", "obj_kk_enemy_slash_Draw_0_gml_106_0"), 9999, 9999, 0.7, 1, 0)
            draw_sprite(spr_musical_dancing_ui, 0, (((__view_get((0 << 0), 0) + 228) + xoffset) + (sin((siner2 / 4)) * 3)), (((__view_get((1 << 0), 0) + 386) + yoffset) + 30))
        }
        else if (danceCounter == 2)
        {
            draw_text_ext_transformed((__view_get((0 << 0), 0) + 258), (((__view_get((1 << 0), 0) + 369) + yoffset) + 30), stringsetloc("2 Turns!", "obj_kk_enemy_slash_Draw_0_gml_111_0"), 9999, 9999, 0.7, 1, 0)
            draw_sprite(spr_musical_dancing_ui, 0, (((__view_get((0 << 0), 0) + 228) + xoffset) + (sin((siner2 / 0.8)) * 3)), (((__view_get((1 << 0), 0) + 386) + yoffset) + 30))
        }
        else
        {
            draw_text(((__view_get((0 << 0), 0) + 258) + xoffset), (((__view_get((1 << 0), 0) + 369) + yoffset) + 30), stringsetloc("Not Dancing", "obj_kk_enemy_slash_Draw_0_gml_116_0"))
            draw_sprite(spr_musical_notdancing_ui, 0, (((__view_get((0 << 0), 0) + 228) + xoffset) + (sin((siner2 / 10)) * 3)), (((__view_get((1 << 0), 0) + 386) + yoffset) + 30))
        }
    }
}
